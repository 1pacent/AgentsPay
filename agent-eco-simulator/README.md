...
**A synthetic agent-economy testbed for the [AgentPays](https://github.com/1pacent/AgentsPay) protocol.**

*Forked from [mirofish-offline](https://github.com/EleutheroiEdge/mirofish-offline). Social actions replaced with economic ones. Deterministic ledger added. Test the protocol before giving real agents real money.*
