  ...
  <div class="home-container">
    ...
    <nav class="navbar" :style="s.navbar">
      ...
      <div class="nav-links" :style="s.navLinks">
        <router-link to="/eco" :style="s.ecoLink">Agent Eco Simulator →</router-link>
...
const s = reactive({
  ...
  ecoLink: { color: '#FF4500', textDecoration: 'none', fontFamily: mono, fontSize: '0.85rem', fontWeight: '700', letterSpacing: '1px' },
